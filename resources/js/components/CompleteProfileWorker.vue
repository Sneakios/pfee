<template>
    <div>
       ...
       <div class="col-md-4 offset-md-4" >             <!-- Button trigger modal -->
<button type="button" style="border-radius: 5px;margin:12px;font-size:15px;background-color:red;border: 2px red solid;color:white;font-size:13px;font-weight:600;width:100px" data-toggle="modal" data-target="#exampleModal">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12" style="width:94%;margin-left:14px">
                                                        <select id="ville" :class="['form-select',errors.skills?'is-invalid':'']" v-model="skills">
...
<script>
    ...
    methods:{
        addWorkerInfo(){
        axios.post('/addWorkerInfo',{skills:this.skills,description:this.description})
        .then((response)=>{
